...
prop_convertITNKeys =
  propertyOnce $ do
    ...
    -- Generate haskell stake verification key & signing key
    execCardanoCLIParser
      [itnVerKeyFp, itnSignKeyFp, outputHaskellVerKeyFp, outputHaskellSignKeyFp]
      "prop_convertITNKeys.convert_itn_keys"
        $ evalCardanoCLIParser [ "shelley","stake-address","convert-itn-key"
                               ...
                               , "--out-verification-key-file", outputHaskellVerKeyFp
                               , "--out-signing-key-file", outputHaskellSignKeyFp
                               ]
